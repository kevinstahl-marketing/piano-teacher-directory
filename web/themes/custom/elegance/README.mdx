...
elegance theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of elegance theme and run the following commands:
`nvm use`
...
`drush en elegance -y`
`drush config-set system.theme default elegance -y`
